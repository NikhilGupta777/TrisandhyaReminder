...
import { BookOpen, Bell, BarChart3, Users, Clock, Music, Sparkles, Shield, LogIn } from "lucide-react";
    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="relative w-full flex flex-col items-center justify-center text-center px-4 sm:px-6 py-16 space-y-6 sm:space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/20 backdrop-blur-sm rounded-full border border-primary/30">
            ...
            <span className="text-sm text-white/90">Sacred Path to Satya Yuga</span>
          </div>
          ...
          <p className="text-lg sm:text-xl text-white/95 max-w-3xl px-4 leading-relaxed">
            ...
            Experience intelligent prayer reminders, track your spiritual progress, 
            and access authentic content from Bhavishya Malika.
          </p>
          ...
          <div className="grid grid-cols-3 gap-4 sm:gap-8 pt-8 max-w-2xl">
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-white">3x</div>
              <div className="text-sm text-white/80">Daily Prayers</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-white">10min</div>
      ...
      <div className="py-12 sm:py-20 px-4 sm:px-6 bg-background">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold font-serif mb-4">What is Trisandhya?</h2>
            <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Trisandhya, the sacred practice of offering prayers to Lord Mahavishnu three times daily—at dawn, 
              noon, and sunset—is mentioned in the 600-year-old Bhavishya Malika scripture as the path to 
              salvation during Kaliyuga's end times.
            </p>
          </div>
          ...
          <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-4">
            <Card className="p-6 text-center space-y-4 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Precise timing reminders for Pratah (3:45-6:30 AM), Madhyahna (11:30 AM-1 PM), 
                and Sayam Sandhya (5-6:30 PM)
              </p>
            </Card>
            ...
            <Card className="p-6 text-center space-y-4 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Authentic Vishnu Shodasha Naam, Dashavatara Stotram, Durga Madhav Stuti, 
                and Kalki Mahamantra with meanings
              </p>
            </Card>
            ...
            <Card className="p-6 text-center space-y-4 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Visual calendar, streak counter, and daily Japa tracking to maintain 
                consistency in your spiritual practice
              </p>
            </Card>
      ...
      <div className="py-12 sm:py-20 px-4 sm:px-6 bg-primary/5">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold font-serif text-center mb-12 sm:mb-16">Spiritual Benefits</h2>
          <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Shield from upcoming calamities and the 64 types of viruses predicted for the future
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Reduces stress, eliminates depression, improves concentration and boosts self-confidence
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Liberates seven generations of your lineage and ensures opportunity to witness Lord Kalki
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Lower blood pressure, better sleep quality, and improved overall physical well-being
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Daily practice fosters self-realization and understanding of life's true purpose
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Enhances family bonding and encourages positive social participation
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="py-16 sm:py-20 px-4 sm:px-6 bg-background">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <h2 className="text-3xl sm:text-4xl font-bold font-serif">Start Your Sacred Journey Today</h2>
          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
            Join thousands of devotees practicing the sacred Trisandhya path. 
            Begin with just 10 minutes, three times a day, and experience profound transformation.
          </p>
          <Button 
            size="lg" 
            onClick={() => window.location.href = "/login"}
          ...
          <p className="text-sm text-muted-foreground pt-4">
            Free to use • No credit card required • Authentic content from Bhavishya Malika
          </p>
        </div>
      </div>
    </div>
